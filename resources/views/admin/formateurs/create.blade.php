    ...
    <nav>
        <div class="row clearfix">
            <ul class="main-nav" animate slideInDown>
                ...
                <li><a href="{{ route('admin.formateurs.index') }}">Formateur</a></li>
            </ul>
        </div>
    </nav>
    <section class="packages" id="packages">
        <h1 class="heading"> Ajouter <span>un formateur</span> </h1>
        <form method="post" action="{{ route('admin.formateurs.store') }}">
            @csrf
            ...
            <table class="table2">
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' value="{{ old('specialite') }}"  name='specialite' placeholder='specialite' required class="box" />
                        @error('specialite')
                            <p class="error-feedback">{{ $message }}</p>
                        @enderror
